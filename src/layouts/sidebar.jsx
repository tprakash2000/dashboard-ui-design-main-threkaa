    ...
    return (
        ...
        >
            <div className="flex gap-x-3 p-3">
                ...
                />
                {!collapsed && <p className="text-lg font-medium text-slate-900 transition-colors dark:text-slate-50">Dashboard Pro</p>}
            </div>
            <div className="flex w-full flex-col gap-y-4 overflow-y-auto overflow-x-hidden p-3 [scrollbar-width:_thin]">
                {navbarLinks.map((navbarLink) => (
                    ...
                    >
                        <p className={cn(
                            "sidebar-group-title",
                            collapsed ? "md:w-[45px] md:text-center" : "md:w-full"
                        )}>
                        ...
                        {navbarLink.links.map((link) => (
                            <NavLink
                                ...
                                className={({ isActive }) => cn(
                                    "sidebar-item",
                                    collapsed ? "md:w-[45px] md:justify-center" : "md:w-full",
